...
<body>
    <div class="remote-container">
        ...
        <div class="d-pad">
            <!-- Adicionado event.preventDefault() através da função e onmouseleave para segurança -->
    ...
    <script>
        ...
        function toggleMode(e) {
            ...
            if (modoManualAtivo) { 
                ...
                // Para o carro ao voltar pro autônomo por segurança
                control('PARAR');
            }
        ...
        function control(cmd, e) {
            if(e && e.cancelable) e.preventDefault(); // Bloqueia zoom e seleção de texto no mobile
            
            // Só exibe o comando na tela se estiver em modo manual
            if (modoManualAtivo) { 
...
void setup() {
  ...
  // --- NOVA ROTA: Controle de Modo (Manual/Autônomo) ---
  server.on("/setmode", []() {
    String mode = server.arg("mode");
    Serial.print("Modo alterado para: "); Serial.println(mode);
    // Aqui você poderá adicionar a lógica futura de ligar/desligar a leitura do sensor ultrassônico
